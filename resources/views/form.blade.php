...
<div class="modal fade" id="single-data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <ul class="list-group">
            <li class="list-group-item"><strong>ID:</strong> <span class="" id="contactid"></span></li>
            <li class="list-group-item"><strong>Name: </strong><span class="" id="fullname"></span> </li>
            <li class="list-group-item"><strong>Email:</strong> <span class="" id="contactemail"></span></li>
            <li class="list-group-item"><strong>Phone:</strong> <span class="" id="contactnumber"></span></li>
            <li class="list-group-item"><strong>Religion:</strong> <span class="" id="creligion"></span></li>
          </ul>
      </div>
    </div>
  </div>
